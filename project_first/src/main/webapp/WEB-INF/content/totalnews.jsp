			...
			<div class="card-header">
				...
				<table><tr>
						<td>
																<select class="form-control"onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
    <option value="" selected disabled hidden>Choose here</option>
    <option selected value="totalnews.do" class="form-control">전체뉴스</option>
    <option value="news.do" class="form-control">오늘뉴스</option>
...
%></p>
					<div class="table-responsive">
						<table class="table table-hover" id="dataTables-example">
							...
							<tbody>
							<c:forEach var="news" begin="${startNum}" end="${endNum}" items="${list}" >
								...
								<c:set var="no" value="${no-1}"/>
									...
									<td class="testline" align="center">${news.newstime}</td>
									<td class="testline" align="center"><a href="${news.newsurl}" target="_blank"><i class="la la-internet-explorer"></i>Link</a></td>
									
				

								</tr>
								<tr style="display: none;" id="scontentsub" class="subshow" >
<td colspan="4" align="center">${news.content}</td>
	   	...
	   	<tr>
	   		<td align="center">
				...
				<%@ page import="com.project.*"%>
	   				 ...
	   				 <li class="page-item" ><a class="page-link" href="totalnews.do?${nowurl}&pageNum=${startPage-1}">Previous</a></li>   				 
	   			</c:if>
	   			<c:forEach var="pg" begin="${startPage}" end="${endPage}">
	   				<c:if test="${currentPage==pg}">
	   					<li class="page-item"><a class="page-link" href="totalnews.do?${nowurl}&pageNum=${pg}" style="color:red;">${pg}</a></li>
	   				</c:if>
	   				<c:if test="${currentPage!=pg}">
	   					<li class="page-item"><a class="page-link" href="totalnews.do?${nowurl}&pageNum=${pg}" style="color:black;">${pg}</a></li>
	   				</c:if>
	   			</c:forEach>
	   			<c:if test="${endPage<totalPage}">
	   				<li class="page-item"><a class="page-link" href="totalnews.do?${nowurl}&pageNum=${endPage+1}">Next</a></li>   
	   			</c:if>
	   			</ul>
