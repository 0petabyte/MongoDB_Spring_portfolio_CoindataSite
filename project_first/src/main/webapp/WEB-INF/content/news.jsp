...
<!-- 						<select class="form-control" id="whatday"
	...
	<select class="form-control"onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
    <option value="" selected disabled hidden>Choose here</option>
    <option selected value="news.do" class="form-control">오늘뉴스</option>
    <option value="totalnews.do" class="form-control">전체뉴스</option>
</select></td>
...
<td colspan="4" align="center" > <br>${news.content}</td>
	   	...
	   	<tr>
	   		<td align="center">
				...
				<%@ page import="com.project.*"%>
	   				 ...
	   				 <li class="page-item" ><a class="page-link" href="news.do?${nowurl}&pageNum=${startPage-1}">Previous</a></li>   				 
	   			</c:if>
	   			<c:forEach var="pg" begin="${startPage}" end="${endPage}">
	   				<c:if test="${currentPage==pg}">
	   					<li class="page-item"><a class="page-link" href="news.do?${nowurl}&pageNum=${pg}" style="color:red;">${pg}</a></li>
	   				</c:if>
	   				<c:if test="${currentPage!=pg}">
	   					<li class="page-item"><a class="page-link" href="news.do?${nowurl}&pageNum=${pg}" style="color:black;">${pg}</a></li>
	   				</c:if>
	   			</c:forEach>
	   			<c:if test="${endPage<totalPage}">
	   				<li class="page-item"><a class="page-link" href="news.do?${nowurl}&pageNum=${endPage+1}">Next</a></li>   
	   			</c:if>
	   			</ul>
