	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				...
				<form name="search" method="get" action="totalnews.do"
				onsubmit="return check()">
				<table><tr>
						<td>
																<select class="form-control"onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
    <option value="" selected disabled hidden>Choose here</option>
    <option selected value="chartnewstotal.do" class="form-control">전체뉴스</option>
    <option value="chartnewstoday.do" class="form-control">오늘뉴스</option>
...
<td colspan="4" align="center">${chartnews.content}</td>
	   	...
	   	<tr>
	   		<td align="center">
				...
				<%@ page import="com.project.*"%>
	   				 ...
	   				 <li class="page-item" ><a class="page-link" href="chartnewstotal.do?${nowurl}&pageNum=${startPage-1}">Previous</a></li>   				 
	   			</c:if>
	   			<c:forEach var="pg" begin="${startPage}" end="${endPage}">
	   				<c:if test="${currentPage==pg}">
	   					<li class="page-item"><a class="page-link" href="chartnewstotal.do?${nowurl}&pageNum=${pg}" style="color:red;">${pg}</a></li>
	   				</c:if>
	   				<c:if test="${currentPage!=pg}">
	   					<li class="page-item"><a class="page-link" href="chartnewstotal.do?${nowurl}&pageNum=${pg}" style="color:black;">${pg}</a></li>
	   				</c:if>
	   			</c:forEach>
	   			<c:if test="${endPage<totalPage}">
	   				<li class="page-item"><a class="page-link" href="chartnewstotal.do?${nowurl}&pageNum=${endPage+1}">Next</a></li>   
	   			</c:if>
	   			</ul>
