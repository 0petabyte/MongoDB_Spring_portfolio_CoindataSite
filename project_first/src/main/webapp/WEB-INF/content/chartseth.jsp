...
<td>
    ...
    <option value="charts.do" class="form-control">BTC</option>
    <option selected value="charteth.do" class="form-control">ETH</option>
</select></td></tr></table>
...
<br><br><br> -->
						...
						<table class="table table-bordered" id="dataTables-example">
							...
							<c:forEach var="ethtradeshop" begin="${startNum}" end="${endNum}" items="${list}" >
	
    <th width="10%">${ethtradeshop.uniquename}</th>
						</c:forEach>
						</tr>
						
													<c:forEach var="ethtradeshop" begin="${startNum}" end="${endNum}" items="${list}" >

    <td><fmt:formatNumber value="${ethtradeshop.lastprice}" pattern="#,###" /></td>
