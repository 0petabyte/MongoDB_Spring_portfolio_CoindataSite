...
@Controller
public class KoreanewTotalController {
	
	@Autowired
	private KoreanewsTotalDao dao;
...
/*	@RequestMapping("/main.do")
	...
	@RequestMapping("/koreanewstotal.do")
			...
			String title, String whatday, String newtime, String nowurl,HttpServletRequest request, String keyword2)
	{
		...
		List<KoreanewsTotalDto> list=dao.findList(keyWord, keyField, title, whatday, newtime, nowurl, keyword2);
		...
		model.setViewName("/1/content/koreanewstotal");
