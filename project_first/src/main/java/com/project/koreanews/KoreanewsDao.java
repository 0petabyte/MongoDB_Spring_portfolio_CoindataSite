...
public class KoreanewsDao {
	...
	{
		mongoTemp.dropCollection(KoreanewsDao.class);
	}
	
	public List<KoreanewsDto> findList(String keyWord, String keyField, String title, String whatday, String newtime, String nowurl, String keyword2)
	{
...
/*		Query query=new Query(Criteria.where("_id").in("a1","a2","a3"));
		...
		*/
	    ...
	    List<KoreanewsDto> list = this.mongoTemp.find(query, KoreanewsDto.class);
