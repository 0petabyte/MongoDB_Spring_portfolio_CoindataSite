...
public class ChartTotalDao {
	...
	{
		mongoTemp.dropCollection(ChartTotalDao.class);
	}
	
	public List<ChartTotalDto> findList(String keyWord, String keyField, String title, String whatday, String newtime, String nowurl,
			String keyword2)
	{
...
/*	    
	    ...
	    */
	    ...
	    List<ChartTotalDto> list = this.mongoTemp.find(query, ChartTotalDto.class);
