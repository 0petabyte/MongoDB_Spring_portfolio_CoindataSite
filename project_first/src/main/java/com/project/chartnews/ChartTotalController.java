...
@Controller
public class ChartTotalController {
	
	@Autowired
	private ChartTotalDao dao;
...
/*	@RequestMapping("/main.do")
	...
	@RequestMapping("/chartnewstotal.do")
			...
			String title, String whatday, String newtime, String nowurl,HttpServletRequest request, String keyword2)
	{
		...
		List<ChartTotalDto> list=dao.findList(keyWord, keyField, title, whatday, newtime, nowurl, keyword2);
		...
		model.setViewName("/1/content/chartnewstotal");
