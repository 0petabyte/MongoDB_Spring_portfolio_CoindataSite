...
@Controller
public class ChartTodayController {
	
	@Autowired
	private ChartTodayDao dao;
...
/*	@RequestMapping("/main.do")
	...
	@RequestMapping("/chartnewstoday.do")
			...
			String title, String whatday, String newtime, String nowurl,HttpServletRequest request, String keyword2)
	{
		...
		List<ChartTodayDto> list=dao.findList(keyWord, keyField, title, whatday, newtime, nowurl, keyword2);
		...
		model.setViewName("/1/content/chartnewstoday");
