...
/*	@RequestMapping("/main.do")
			...
			String title, String whatday, String newtime, String nowurl,HttpServletRequest request, String keyword2)
	{
		...
		List<UserDto> list=dao.findList(keyWord, keyField, title, whatday, newtime, nowurl, keyword2);
		...
		model.setViewName("/1/content/news");
		
		return model;
		
	}
	
//	@RequestMapping("/allprice.do")
//	public String news() {
//		return "/1/content/allprice";
//	}
...
//	@RequestMapping("/allethprice.do")
//	public String ethprice() {
//		return "/1/content/allethprice";
//	}
//	
	
//	@RequestMapping("/allbchprice.do")
//	public String bchprice() {
//		return "/1/content/allbchprice";
//	}
//	
