...
/*	@RequestMapping("/main.do")
			...
			String title, String whatday, String newtime, String nowurl,HttpServletRequest request, String keyword2)
	{
		...
		List<MarketcapDto> list=dao.findList(keyWord, keyField, title, whatday, newtime, nowurl, keyword2);
		...
		model.setViewName("/1/content/marketcap");
		
		
		List<SocialCntDto> list2=dao.findList1();
		
		model.addObject("list2",list2);
		
		
		List<SocialLikeDto> list3=dao.findList2();
		
		model.addObject("list3",list3);
		
		
		List<MarketcapDto> list4=dao.findList3();
		
		model.addObject("list4",list4);
		
		List<MarketcapDto> list5=dao.findList4();
		
		model.addObject("list5",list5);
		
		List<MarketcapDto> list6=dao.findList5();
		
		model.addObject("list6",list6);
		
		List<MarketcapDto> list7=dao.findList6();
