...
@Controller
public class BtcscanController {

	
	@Autowired
	private BtcscanDao dao;
	
	
	@RequestMapping(value="/btcscan.do", method= RequestMethod.GET)
	@ResponseBody
	public ModelAndView list(@RequestParam(value="pageNum",defaultValue="1") int currentPage, String nowtime,String nowurl,HttpServletRequest request)
	{
		...
		List<BtcscanDto> list=dao.findList(nowtime, nowurl);
		int endPage;
		...
		model.setViewName("/1/content/btcscan");
