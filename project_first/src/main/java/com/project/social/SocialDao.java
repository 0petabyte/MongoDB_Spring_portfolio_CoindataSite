...
public class SocialDao {
	...
	{
		mongoTemp.dropCollection(SocialDao.class);
	}
	
	public List<SocialDto> findList(String keyWord, String keyField, String title, String whatday, String newtime, String nowurl, String keyword2)
	{
...
/*	    
	    ...
	    */
	    ...
	    List<SocialDto> list = this.mongoTemp.find(query, SocialDto.class);
